...
case class GridRowGap(value: LengthUnit) extends StyleBaseProperty
case class GridColGap(value: LengthUnit) extends StyleBaseProperty
...
object StyleProperty {
  ...
  styleBasePickler
    ...
    .addConcreteType[GridRowGap]
    .addConcreteType[GridColGap]
